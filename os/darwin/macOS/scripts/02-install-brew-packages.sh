...
brew bundle --quiet --file=Brewfile --upgrade --cleanup
...
codex completion zsh >/opt/homebrew/share/zsh-completions/_codex
deck completion zsh >/opt/homebrew/share/zsh-completions/_deck
